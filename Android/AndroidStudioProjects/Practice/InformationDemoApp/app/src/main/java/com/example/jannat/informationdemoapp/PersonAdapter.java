...
public class PersonAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        personDataProvider=(PersonDataProvider)this.getItem(position);
        handler.firstName.setText(personDataProvider.getFirstName());
        handler.lastName.setText(personDataProvider.getLastName());
        handler.email.setText(personDataProvider.getEmail());
        handler.dateOfBirth.setText(personDataProvider.getDateOfBirth());
        handler.gender.setText(personDataProvider.getGender());
        return row;
    }
}
