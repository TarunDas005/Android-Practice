package com.example.jannat.masterflow.dummy;
...
public class DummyContent {
    ...
    static {
        ...
        addItem(new DummyItem("3","Filehippo","http://www.filehippo.com"));
        addItem(new DummyItem("4","Prothom-Alo","http://www.prothom-alo.com"));
    }
